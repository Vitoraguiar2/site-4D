...
<html>
    ...
    <body>
        <div id="corpo">
            ...
            <p style="text-align: justify;">
                Seguindo, se você colocar outro ponto no plano e conecta-los você terá uma linha um objeto de somente 1 dimensão:
            </p>
            <p>
            ...
            <h2><span>Visualização do Espaço 4D</span></h2>
            <p style="text-align: justify;">
